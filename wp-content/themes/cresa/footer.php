...
<!--				<div id="social">
					<a href="mobileapp.html" title="mobile apps" id="mobile"><img src="images/phone.png" alt="mobile phone icon by Jino & Christine"></a>

					<a href="http://www.cresa911.blogspot.com/" title="Blog" id="blog"><img src="images/blogspot.png" alt="blog icon "></a> <!-- credit by www.alessandracravero.it -->
<!--					<a href="https://www.facebook.com/CRESA.911" title="Facebook" id="facebook"><img src="images/fb.png" alt="facebook logo by www.alessandracravero.it"></a>
					<a href="https://twitter.com/cresa" title="Twitter icon By www.alessandracravero.it" id="twitter"><img src="images/twitter.png" alt="twitter logo by www.alessandracravero.it"></a>
					
-->					
<!--					<a href="http://feeds.feedburner.com/cresa911" title="rss" id="rss"><img src="images/rss.png" alt="rss logo by www.alessandracravero.it"></a>
-->
<!--			</div> <!-- end social --> 
...
-->
						...
						<div class="col-sm-4" id="footnav1">
							<ul>
						...
						<div class="col-sm-4" id="footnav2">
							<ul>
	...
	<!--			</div>  -->
				...
				<div id="social">
					<a href="mobileapp.html" title="mobile apps" id="mobile"><img src="<?php bloginfo('stylesheet_directory') ?>/images/phone.png" alt="mobile apps"></a><!-- icon by Jino & Christine -->

					<a href="http://www.cresa911.blogspot.com/" title="Blog" id="blog"><img src="<?php bloginfo('stylesheet_directory') ?>/images/blogspot.png" alt="blog"></a> <!-- credit by www.alessandracravero.it -->
					<a href="https://www.facebook.com/CRESA.911" title="Facebook" id="facebook"><img src="<?php bloginfo('stylesheet_directory') ?>/images/fb.png" alt="facebook"></a><!-- logo by www.alessandracravero.it -->
					<a href="https://twitter.com/cresa" title="Twitter" id="twitter"><img src="<?php bloginfo('stylesheet_directory') ?>/images/twitter.png" alt="twitter"></a><!-- logo by www.alessandracravero.it -->
					
					
					<a href="http://feeds.feedburner.com/cresa911" title="rss" id="rss"><img src="<?php bloginfo('stylesheet_directory') ?>/images/rss.png" alt="rss"></a><!-- logo by www.alessandracravero.it -->
				</div> <!-- end social -->				
