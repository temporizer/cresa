...
-->
	...
	<!--			</div>  -->
				...
				<div id="social">
					<a href="mobileapp.html" title="mobile apps" id="mobile"><img src="images/phone.png" alt="mobile apps"></a><!-- icon by Jino & Christine -->

					<a href="http://www.cresa911.blogspot.com/" title="Blog" id="blog"><img src="images/blogspot.png" alt="blog"></a> <!-- credit by www.alessandracravero.it -->
					<a href="https://www.facebook.com/CRESA.911" title="Facebook" id="facebook"><img src="images/fb.png" alt="facebook"></a><!-- logo by www.alessandracravero.it -->
					<a href="https://twitter.com/cresa" title="Twitter" id="twitter"><img src="images/twitter.png" alt="twitter"></a><!-- logo by www.alessandracravero.it -->
					
					
					<a href="http://feeds.feedburner.com/cresa911" title="rss" id="rss"><img src="images/rss.png" alt="rss"></a><!-- logo by www.alessandracravero.it -->
				</div> <!-- end social -->				
